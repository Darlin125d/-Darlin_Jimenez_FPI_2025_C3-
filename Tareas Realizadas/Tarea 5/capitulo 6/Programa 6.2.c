...
/* Suma matrices.
   El programa, al recibir como datos dos arreglos bidimensionales
   del mismo tamaño, calcula la suma de ambos y la almacena en un
   tercer arreglo bidimensional.
*/
