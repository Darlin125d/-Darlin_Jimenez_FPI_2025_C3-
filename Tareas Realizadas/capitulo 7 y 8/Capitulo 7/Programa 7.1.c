...
{
    char p1, p2, p3 = '$';
    /* Declaración de las variables tipo caracter p1, p2 y p3.
       Observa que a p3 se le asigna el símbolo $. */
    ...
    /* Luego de leer un caracter siempre es conveniente escribir la función fflush
       ...
       dato se oprime el return y luego cuando volvemos a leer un caracter o una cadena
       de caracteres se toma a ese return como el nuevo dato ingresado. */
