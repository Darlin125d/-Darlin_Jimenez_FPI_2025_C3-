...
void main(void)
{
    ...
    /* Se asigna una cadena constante a cad0 (apuntador). */

    char cad1[20] = "Hola";
    /* cad1 tiene espacio para 20 caracteres. */

    char cad2[] = "Mexico";
    /* Se asignan los caracteres de la cadena mas el caracter '\0'. */

    char cad3[] = {'B','i','e','n','v','e','n','i','d','o','\0'};
    /* Otra forma de declarar cadenas caracter por caracter. */
